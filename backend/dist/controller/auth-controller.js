...
export const registerUser = async (req, res) => {
    try {
        ...
        return successResponse(res, 201, { id: newUser._id, name: newUser.name, email: newUser.email }, "Sign Up Successfull!");
    }
    catch (err) {
...
export const loginUser = async (req, res) => {
    try {
        ...
        return successResponse(res, 200, { id: user._id, name: user.name, email: user.email }, "Login Successfull!");
    }
    catch (err) {
        if (err instanceof Error)
